                ...
                <div className="space-y-5">
                    <div className="flex gap-2 items-center">
                        ...
                        <div className="flex flex-col gap-1">
                            <Label className="text-white" variant={'legend'}>Dacopsy</Label>
                            <Label className="text-white font-normal" variant={"title"}>Datacooker for Psychologists</Label>
                        </div>
                    </div>
                    ...
                    <div className="pt-20">
                        <Label variant={"label"} className="text-white font-semibold">Dacopsy India Pvt Ltd. All Rights Reserved</Label>
                    </div>
                </div>
            </div>
            <div className="pl-16 w-[55%] gap-5">
                <div className="justify-start flex flex-col items-start h-40">
                    <Label className="font-normal text-primary" variant={"title"}>Welcome to</Label>
                    <Label className="text-primary" variant={'legend'}>Dacopsy!</Label>
                </div>
                <div className="h-48 items-center space-y-4">
                    ...
                    <div>
                        <Link to='#' className="w-fit float-right underline underline-offset-4 text-gray-400 hover:text-primary">Forgot your password?</Link>
                    </div>
                </div>
                <div className="flex flex-col gap-8 mt-16">
                    <Button className="h-12 text-lg font-light">Sign In</Button>
                    <Button className="text-gray-500 h-12 text-lg font-light" variant={'outline'}>
                        <FcGoogle size={20} />
                        Connect via Google</Button>
                </div>
