...
export default function Header() {
    return (
        <div className="flex  px-10 h-28 items-center bg-primary justify-between">
            ...
            <div className="">
                <InputWithIcon className="border w-[600px] h-[50px] focus:border-neutral-200 items-center bg-transparent text-white placeholder:text-white" placeholder="Search datasets, projects" icon={<FaSearch size={16} />} position={"right"} />
            </div>
            <div>
                <DropdownMenu>
